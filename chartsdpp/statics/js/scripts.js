...
const ctx5 = document.getElementById('mySecondChart');
const ctx6 = document.getElementById('mythirdChart');
const ctx7 = document.getElementById('Chart4');
